...
import com.karimandco.xml.ImportExportCSV;
import com.karimandco.xml.ImportExportJSON;
import com.karimandco.xml.ImportExportXML;
import java.io.File;
...
public class CreationDuCV extends javax.swing.JPanel {
    ...
    public Integer idUtilisateur=1;
    private Integer idTabFormation = 1;
    private Integer idTabExperiencePro = 1;
    private Integer idCV = null;
    private JFileChooser fichier = new JFileChooser();
    private Utilisateur util;
    private ImportExportXML expXML;
    private ImportExportJSON expJSON;
    private ImportExportCSV expCSV;
    ...
    public CreationDuCV(Integer idCV, Integer idUtilisateur) {
        ...
        fichier.setFileSelectionMode(JFileChooser.DIRECTORIES_ONLY);
        fichier.setMultiSelectionEnabled(false);
        
        expXML = new ImportExportXML("cv.xml");
        expJSON = new ImportExportJSON("cv.json");
        expCSV = new ImportExportCSV("cv.csv");
    }
    ...
    public void setUtil(Utilisateur util) {
        this.util = util;
        expXML.setUtil(util);
        expJSON.setUtil(util);
        expCSV.setUtil(util);
    }
    
    
    
    public Integer recupIdCV(Integer idUtil){
        Integer result = null;
        if (com.karimandco.bdd.DaoSIO.getInstance().connexionActive()) {
            System.out.println(com.karimandco.bdd.DaoSIO.getInstance().connexionActive());
            try{
                ResultSet res = com.karimandco.bdd.DaoSIO.getInstance().requeteSelection("SELECT id FROM cv WHERE id_utilisateur = " + idUtil);
                if (res.next()) {
                    result = res.getInt("id");
                }
            }catch(SQLException e){
                System.out.println("ERREUR recupIdCV("+idUtil+") : "+e);
            }
        }
        return result;
    }
    ...
    public void setIdUtilisateur(Integer idUtilisateur) {
        this.idUtilisateur = idUtilisateur;
        try {
            idCV = recupIdCV(idUtilisateur);
            chargerCV();
            System.out.println("OK CV");
        } catch (SQLException ex) {
            System.out.println("ERREUR CV");
            Logger.getLogger(CreationDuCV.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jTextFieldMaitriseNom1 = new javax.swing.JTextField();
        ...
        jTextFieldMaitriseNom2 = new javax.swing.JTextField();
        ...
        voirPdf = new com.karimandco.pdf.VoirPdf();
        jLabel7 = new javax.swing.JLabel();
        jButtonExporterXML = new javax.swing.JButton();
        jButtonExporterJSON = new javax.swing.JButton();
        jButtonExporterCSV = new javax.swing.JButton();
        ...
        jTextFieldMaitriseNom1.setText("Titre de la maitrise");
        ...
        jTextFieldMaitriseNom2.setText("Titre de la maitrise");
        ...
        jButtonExporterXML.setText("XML");
        jButtonExporterXML.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jButtonExporterXMLMouseClicked(evt);
            }
        });

        jButtonExporterJSON.setText("JSON");
        jButtonExporterJSON.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jButtonExporterJSONMouseClicked(evt);
            }
        });

        jButtonExporterCSV.setText("CSV");
        jButtonExporterCSV.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jButtonExporterCSVMouseClicked(evt);
            }
        });
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(layout.createSequentialGroup()
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                                    ...
                                                    .addGroup(layout.createSequentialGroup()
                                                        ...
                                                        .addGap(18, 18, 18)
                                                        .addComponent(jTextFieldMaitriseNom2, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                        .addGap(18, 18, 18)
                                            ...
                                            .addGroup(layout.createSequentialGroup()
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                                    ...
                                                    .addGroup(layout.createSequentialGroup()
                                                        ...
                                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                                            ...
                                                            .addComponent(jLabelMaitrise, javax.swing.GroupLayout.PREFERRED_SIZE, 330, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                            .addGroup(layout.createSequentialGroup()
                                                                .addComponent(jLabel2)
                                                                .addGap(18, 18, 18)
                                                                .addComponent(jTextFieldMaitriseNom1, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                .addGap(18, 18, 18)
                                                ...
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                    ...
                                                    .addGroup(layout.createSequentialGroup()
                                                        .addGap(38, 38, 38)
                                                        .addComponent(jButtonExporterXML)
                                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                        .addComponent(jButtonExporterJSON)
                                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                        .addComponent(jButtonExporterCSV))))))
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(43, 43, 43)
                                        .addComponent(voirPdf, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel2)
                            .addComponent(jTextFieldMaitriseNom1)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel6)
                            .addComponent(jTextFieldMaitriseNom2)
    ...
    private void jButtonExporterXMLMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonExporterXMLMouseClicked
        int result;
        File dossierChoisi;
        String lienDossier;
        result=fichier.showOpenDialog(this);
        
        if (result==JFileChooser.APPROVE_OPTION) {
            dossierChoisi=fichier.getSelectedFile();
            lienDossier=dossierChoisi.toString();
            System.out.println(lienDossier);
            expXML.setNomFichier(lienDossier+"\\cv.xml");
            expXML.exportCV(String.valueOf(this.idCV));
            JOptionPane.showMessageDialog(this, "CV en JSON exporté.");
        }
        
    }//GEN-LAST:event_jButtonExporterXMLMouseClicked

    private void jButtonExporterJSONMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonExporterJSONMouseClicked
        int result;
        File dossierChoisi;
        String lienDossier;
        result=fichier.showOpenDialog(this);
        ...
        if (result==JFileChooser.APPROVE_OPTION) {
            ...
            lienDossier=dossierChoisi.toString();
            System.out.println(lienDossier);
            expJSON.setNomFichier(lienDossier+"\\cv.json");
            expJSON.exportCV(String.valueOf(this.idCV));
            JOptionPane.showMessageDialog(this, "CV en XML exporté.");
        }
    }//GEN-LAST:event_jButtonExporterJSONMouseClicked

    private void jButtonExporterCSVMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonExporterCSVMouseClicked
        int result;
        File dossierChoisi;
        String lienDossier;
        result=fichier.showOpenDialog(this);
        ...
        if (result==JFileChooser.APPROVE_OPTION) {
            ...
            lienDossier=dossierChoisi.toString();
            System.out.println(lienDossier);
            expCSV.setNomFichier(lienDossier+"\\cv.csv");
            expCSV.exportCV(String.valueOf(this.idCV));
            JOptionPane.showMessageDialog(this, "CV en CSV exporté.");
        }
    }//GEN-LAST:event_jButtonExporterCSVMouseClicked
    ...
    private void handleMaitrise(){
        String value1 = jSpinnerLevelMaitrise1.getValue().equals("") ? "0" : jSpinnerLevelMaitrise1.getValue().toString();
        String value2 = jSpinnerLevelMaitrise2.getValue().equals("") ? "0" : jSpinnerLevelMaitrise2.getValue().toString();

        if (value1.matches("[0-9]+")) {
            if (!value1.equals("") && Integer.parseInt(value1) >= 0 && Integer.parseInt(value1) <= 100) {
                jProgressBar1.setValue(Integer.parseInt(value1));
            }
        }
        if (value2.matches("[0-9]+")) {
            if (!value2.equals("") && Integer.parseInt(value2) >= 0 && Integer.parseInt(value2) <= 100) {
                jProgressBar2.setValue(Integer.parseInt(value2));
            }
        }
    }
            ...
            if (utilisateur != null && utilisateur.size() > 0) {
                ...
                if (!titre.equals("")) {
                    ...
                    if (!description.equals("")) {
                        ...
                        int maitrise2 = jProgressBar2.getValue();
                        String nom_maitrise = jTextFieldMaitriseNom1.getText();
                        String nom_maitrise2 = jTextFieldMaitriseNom2.getText();
                        ...
                        if (!nom_maitrise.equals("") && !nom_maitrise.equals("Titre de la maitrise")) {
                            ...
                            if (update) {
                                res = DaoSIO
                                        .getInstance()
                                        .requeteAction("UPDATE `cv` SET `titre` = '" + titre + "', `description` = '" + description + "', `nom_maitrise` = '" + nom_maitrise + "',`maitrise` = '" + maitrise + "', `nom_maitrise2` = '" + nom_maitrise2 + "',`maitrise2` = '" + maitrise2 + "' WHERE id = " + cv.get(0).get("id"));
                                
                                idCV = (Integer) cv.get(0).get("id");
                            } else {
                                    res = DaoSIO
                                            .getInstance()
                                            .requeteAction("INSERT INTO `cv` (`id`, `titre`, `description`, `signature`, `nom_maitrise`, `maitrise`, `nom_maitrise2`, `maitrise2`, `id_utilisateur`) "
                                                + "VALUES (NULL, '" + titre + "', '" + description + "', '" + signature + "', '" + nom_maitrise + "', '" + maitrise + "', '" + nom_maitrise2 + "', '" + maitrise2 + "', '" + idUtilisateur + "');");
    ...
    public void chargerCV() throws SQLException {
        ...
        if(utilisateur != null){
            ...
            if (cv != null && cv.size() > 0) {
                ...
                jProgressBar2.setValue(Integer.parseInt((String) cv.get(0).get("maitrise2")));
                jSpinnerLevelMaitrise1.setValue(Integer.parseInt((String) cv.get(0).get("maitrise")));
                jSpinnerLevelMaitrise2.setValue(Integer.parseInt((String) cv.get(0).get("maitrise2")));
                jTextFieldMaitriseNom1.setText((String) cv.get(0).get("nom_maitrise"));
                jTextFieldMaitriseNom2.setText((String) cv.get(0).get("nom_maitrise2"));
...
//            this.setVisible(false);
    ...
    private javax.swing.JButton jButtonExporterCSV;
    private javax.swing.JButton jButtonExporterJSON;
    private javax.swing.JButton jButtonExporterXML;
    ...
    private javax.swing.JTextField jTextFieldMaitriseNom1;
    private javax.swing.JTextField jTextFieldMaitriseNom2;
    private javax.swing.JTextField jTextFieldTitre;
    private com.karimandco.pdf.VoirPdf voirPdf;
