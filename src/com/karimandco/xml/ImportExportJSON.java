...
public class ImportExportJSON extends Export {
    ...
    public void exportCV(String idDuCV) {
        ...
        try {
            ...
            //Info
            objFile.write("\"info\": {\r\n");
            objFile.write("\"titre\": \""+cv.getTitre()+"\",\r\n");
            objFile.write("\"description\": \""+cv.getDescription()+"\",\r\n");
            
            objFile.write("\"maitrise1\": {\r\n");
            objFile.write("\"nom\": \""+cv.getNomMaitrise1()+"\",\r\n");
            objFile.write("\"niveau\": \""+cv.getMaitrise1()+"\"\r\n");
            objFile.write("}\r\n");
            objFile.write("\"maitrise2\": {\r\n");
            objFile.write("\"nom\": \""+cv.getNomMaitrise2()+"\",\r\n");
            objFile.write("\"niveau\": \""+cv.getMaitrise2()+"\"\r\n");
            objFile.write("}\r\n");
            objFile.write("}\r\n");
            ...
            for (ExperiencePro exp : expPro) {
                ...
                objFile.write("\"entreprise\": \"" + exp.getEntreprise() + "\",\r\n");
                objFile.write("\"adresse\": \"" + exp.getLieu()+ "\",\r\n");
                objFile.write("\"description\": \"" + exp.getDescription()+ "\",\r\n");
                objFile.write("\"annee_debut\": \"" + exp.getAnneeDebut()+ "\",\r\n");
                objFile.write("\"annee_fin\"; \"" + exp.getAnneeFin() + "\"\r\n");
                objFile.write("}\r\n");
            }
            ...
            for (Formation form : formations) {
                ...
                objFile.write("\"nom\": \"" + form.getNom() + "\",\r\n");
                objFile.write("\"lieu\": \"" + form.getLieu()+ "\",\r\n");
                objFile.write("\"description\": \"" + form.getDescription()+ "\",\r\n");
                objFile.write("\"annee_debut\": \"" + form.getAnneeDebut()+ "\",\r\n");
                objFile.write("\"annee_fin\": \"" + form.getAnneeFin() + "\"\r\n");
                objFile.write("}\r\n");
            }
            objFile.write("}\r\n");
            objFile.close();
